    ...
    public partial class attnovo : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidoCopa", x => x.CopaId);
                    table.ForeignKey(
                        name: "FK_PedidoCopa_Pedido_PedidoId",
                        column: x => x.PedidoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PedidoCozinha", x => x.CozinhaId);
                    table.ForeignKey(
                        name: "FK_PedidoCozinha_Pedido_PedidoId",
                        column: x => x.PedidoId,
                        principalTable: "Pedido",
                        principalColumn: "PedidoId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PedidoCopa_PedidoId",
                table: "PedidoCopa",
                column: "PedidoId");

            migrationBuilder.CreateIndex(
                name: "IX_PedidoCozinha_PedidoId",
                table: "PedidoCozinha",
                column: "PedidoId");
        }
